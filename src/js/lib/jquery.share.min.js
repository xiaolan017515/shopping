!function (r) {
    ...
    function n(r, t, e) {
        ...
        i.font = o;
        var a = i.measureText(e.label).width, u = e.mSize, f = a / n, c = (1 - f) * e.mPosX, s = (1 - u) * e.mPosY, l = c + f, h = s + u, d = .01;
        1 === e.mode ? r.addBlank(0, s - d, n, h + d) : r.addBlank(c - d, s - d, l + d, h + d), t.fillStyle = e.fontcolor, t.font = o, t.fillText(e.label, c * n, s * n + .75 * e.mSize * n)
    }

    function o(r, t, e) {
        var n = e.size, o = e.image.naturalWidth || 1, i = e.image.naturalHeight || 1, a = e.mSize, u = a * o / i, f = (1 - u) * e.mPosX, c = (1 - a) * e.mPosY, s = f + u, l = c + a, h = .01;
    ...
    function c(r, t, e, n, o, i, a, c) {
        var s = r.isDark, l = n + i, h = o + i, d = e.radius * i, g = a - 1, v = a + 1, p = c - 1, w = c + 1, m = s(a, c), T = s(g, p), y = s(g, c), E = s(g, w), A = s(a, w), B = s(v, w), k = s(v, c), b = s(v, p), C = s(a, p);
    ...
    r.fn.share = function (t) {
        function e(t, e) {
            ...
            "prepend" == e.mode ? n.reverse() : n, n.length && r.each(n, function (n, o) {
                var a = i(o, e), u = e.initialized ? t.find(".icon-" + o) : r('<a class="social-share-icon icon-' + o + '" target="_blank"></a>');
                return u.length ? (u.prop("href", a), void(e.initialized || ("prepend" == e.mode ? t.prepend(u) : t.append(u)))) : !0
            })
        }
        ...
        this.each(function () {
            ...
            var t = r.extend({}, s, r(this).data()), o = r(this).addClass("share-component social-share");
